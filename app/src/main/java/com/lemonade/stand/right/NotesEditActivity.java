...
/**
 * Created by navneeeth99 on 25/11/16.
 */

public class NotesEditActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
                ...
                new ResultCallback<DriveContentsResult>() {
                    ...
                    public void onResult(DriveContentsResult result) {
                        ...
                        if (newFilename.equals(fileName)){
                            ...
                            SuperActivityToast.create(NotesEditActivity.this, new Style(), Style.TYPE_BUTTON)
